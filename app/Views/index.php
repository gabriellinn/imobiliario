      ...
      <div class="row justify-content-between align-items-center w-100">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Imóveis</a>
                    </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Sidebar </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Three Column </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Three Column Wide </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Four Column </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Four Column Wide </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Six Column </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Shop Six Column Wide </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Single Product </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Single Product V2 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Blog Classic </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Blog Grid with Sidebar </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Blog Grid Four Column </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Blog No Sidebar </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Blog Right Sidebar </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Single Post </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Single Post No Sidebar </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">About </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Cart </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Checkout </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Coming Soon </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Contact </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Error Page </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">FAQs </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">My Account </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Order Tracking </a>
                    </li>
                    <li>
                      <a href="<?= base_url(' ') ?>" class="dropdown-item item-anchor">Wishlist </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            <li class="d-none d-lg-block">
              <a href="<?= base_url(' ') ?>" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
              ...
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="<?= base_url(' ') ?>" class="item-anchor">Soft leather jackets</a>
                  </h5>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="<?= base_url(' ') ?>" class="item-anchor">Out crop sweater</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Discover Now</a>
        ...
        <div class="row">
            ...
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="<?= base_url(' ') ?>" class="btn btn-common text-uppercase">Shop for men</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="<?= base_url(' ') ?>" class="btn btn-common text-uppercase">Shop for women</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="<?= base_url(' ') ?>" class="btn btn-common text-uppercase">Shop accessories</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <section id="new-arrival" class="new-arrival product-carousel py-5 position-relative overflow-hidden">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <a href="<?= base_url(' ') ?>" class="btn-link">View All Products</a>
      </div>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                ...
                <a href="<?= base_url(' ') ?>" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                  </svg>
                </a>
                <div class="product-content">
                  <h5 class="element-title text-uppercase fs-5 mt-3">
                    <a href="<?= base_url(' ') ?>">Dark florish onepiece</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="<?= base_url(' ') ?>">Cotton off-white shirt</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="<?= base_url(' ') ?>">Crop sweater</a>
                  </h5>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="<?= base_url(' ') ?>" class="text-decoration-none" data-after="Add to cart"><span>$95.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="<?= base_url(' ') ?>" class="text-decoration-none" data-after="Add to cart"><span>$55.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="<?= base_url(' ') ?>" class="text-decoration-none" data-after="Add to cart"><span>$65.00</span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="<?= base_url(' ') ?>">Handmade crop sweater</a>
                  </h5>
                  <a href="<?= base_url(' ') ?>" class="text-decoration-none" data-after="Add to cart"><span>$50.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="<?= base_url(' ') ?>" class="text-decoration-none" data-after="Add to cart"><span>$70.00</span></a>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="blog py-5">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <a href="<?= base_url(' ') ?>" class="btn-link">View All</a>
      </div>
      <div class="row">
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              ...
              <h5 class="post-title text-uppercase">
                <a href="<?= base_url(' ') ?>">How to look outstanding in pastel</a>
              </h5>
        ...
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              ...
              <h5 class="post-title text-uppercase">
                <a href="<?= base_url(' ') ?>">Top 10 fashion trend for summer</a>
              </h5>
        ...
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              ...
              <h5 class="post-title text-uppercase">
                <a href="<?= base_url(' ') ?>">Crazy fashion with unique moment</a>
              </h5>
              <p>Turpis purus, gravida orci, fringilla dignissim lacus, turpis ut suspendisse vel tellus...</p>
            </div>
          </article>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
                <a href="<?= base_url(' ') ?>" class="item-anchor">Home</a>
              </li>
              <li class="menu-item">
                <a href="<?= base_url(' ') ?>" class="item-anchor">About</a>
              </li>
              <li class="menu-item">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-003">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              ...
              <li class="menu-item">
                <a href="<?= base_url(' ') ?>" class="item-anchor">Faqs</a>
              </li>
            </ul>
          </div>
        </div>
